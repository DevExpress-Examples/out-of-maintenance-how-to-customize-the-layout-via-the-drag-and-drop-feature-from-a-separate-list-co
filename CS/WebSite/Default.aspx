...
<%@ Register Assembly="DevExpress.Web.ASPxPivotGrid.v13.1, Version=13.1.0.0, Culture=neutral, PublicKeyToken=79868b8147b5eae4"
            ...
            <dx:ASPxPanel ID="dxpgCustFieldsFieldList" runat="server">
                <PanelCollection>
                    <dx:PanelContent runat="server">
                        <dx:ASPxNavBar ID="ASPxNavBar1" runat="server" ClientInstanceName="ASPxNavBar1" RenderMode="Lightweight">
                            <Groups>
